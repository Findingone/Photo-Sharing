...
import ViewCollection from './components/User/ViewCollection';
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/view/collection" exact element={<ViewCollection />} />
        ...
        <Route path="/public/collections" exact element={<PublicCollections />} />
